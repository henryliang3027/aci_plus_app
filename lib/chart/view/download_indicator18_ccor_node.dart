...
class DownloadIndicator18CCorNodeForm extends StatefulWidget {
  const DownloadIndicator18CCorNodeForm({
    super.key,
  ...
  State<DownloadIndicator18CCorNodeForm> createState() =>
      _DownloadIndicator18CCorNodeFormState();
}

class _DownloadIndicator18CCorNodeFormState
    extends State<DownloadIndicator18CCorNodeForm>
  ...
  Future<List> getLogChunkWithRetry(int chunkIndex) async {
    ...
    for (int j = 0; j < 3; j++) {
      List<dynamic> resultOfLog =
          await dsimRepository.requestCommand1p8GCCorNodeLogChunk(chunkIndex);
