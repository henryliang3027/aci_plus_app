...
class EnvConfig {
  ...
  static late final String benchModePassword;
  ...
  static Future<void> initialize() async {
    ...
    final benchPassword = dotenv.env['BENCH_MODE_PASSWORD'];
    ...
    if (benchPassword == null || benchPassword.isEmpty) {
      throw AssertionError('BENCH_MODE_PASSWORD is not set in .env file');
    }

    expertModePassword = password;
    expertModeDeveloperPassword = developerPassword;
    benchModePassword = benchPassword;
  }
}
