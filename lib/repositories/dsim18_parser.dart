...
class Dsim18Parser {
  ...
  A1P8G0 parseA1P8G0(List<int> rawData) {
    String partName = '';
    String partNo = '';
    String serialNumber = '';
  ...
  A1P8G1 parseA1P8G1(List<int> rawData) {
  ...
  A1P8G2 parseA1P8G2(List<int> rawData) {
  ...
  List<RFInOut> parseRFInOut(List<int> rawData) {
