...
class Amp18Repository {
  ...
  Future<dynamic> requestCommand1p8G3() async {
    ...
    try {
      ...
      print('---rfInOuts---');
      for (RFInOut rfInOut in rfInOuts) {
        print('${rfInOut.frequency}, ${rfInOut.input}, ${rfInOut.output}');
      }
      print('---rfInOuts---');

      print(
          'historicalMinRFOutputPower: ${a1p8grfOutputPowerStatistic.historicalMinRFOutputPower}');

      print(
          'historicalMaxRFOutputPower: ${a1p8grfOutputPowerStatistic.historicalMaxRFOutputPower}');
  ...
  Future<dynamic> requestCommand1p8GRFOutputLogChunk(int chunkIndex) async {
    ...
    try {
      ...
      print('---RFOutputLog---');
      for (RFOutputLog rfOutputLog in rfOutputLogs) {
        print('${rfOutputLog.dateTime}, ${rfOutputLog.rfOuts}');
      }
      print('---RFOutputLog---');
