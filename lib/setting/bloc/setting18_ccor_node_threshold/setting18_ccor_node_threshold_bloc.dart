...
class Setting18CCorNodeThresholdBloc extends Bloc<
  ...
  void _onOutputAttenuation1Changed(
    OutputAttenuation1Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputEqualizer1Changed(
    OutputEqualizer1Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputAttenuation3Changed(
    OutputAttenuation3Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputEqualizer3Changed(
    OutputEqualizer3Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputAttenuation4Changed(
    OutputAttenuation4Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputEqualizer4Changed(
    OutputEqualizer4Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputAttenuation6Changed(
    OutputAttenuation6Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
  ...
  void _onOutputEqualizer6Changed(
    OutputEqualizer6Changed event,
    Emitter<Setting18CCorNodeThresholdState> emit,
  ) {
    emit(state.copyWith(
      submissionStatus: SubmissionStatus.none,
