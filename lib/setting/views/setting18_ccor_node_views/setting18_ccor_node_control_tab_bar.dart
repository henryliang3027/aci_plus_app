...
import 'package:aci_plus_app/setting/views/setting18_ccor_node_views/setting18_ccor_node_ingress_control_page.dart';
                ...
                tabs: [
                  ...
                  Tab(
                    child: SizedBox(
                      ...
                      child: Center(
                        child: Text(
                          AppLocalizations.of(context)!.ingressControl,
                        ),
                      ),
                    ),
                  ),
          ...
          const Expanded(
            child: TabBarView(
              ...
              children: [
                ...
                Setting18CCorNodeIngressControlPage(),
              ],
            ),
          ),
        ],
