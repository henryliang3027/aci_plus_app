...
class Setting18DistributionConfigForm extends StatelessWidget {
  const Setting18DistributionConfigForm({super.key});
          ...
          children: [
            ...
            FloatingActionButton(
              ...
              backgroundColor: ModeProperty.isExpertMode
                  ? state.distributionConfigs.length < 3
...
class _DeviceListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> buildDistributionConfigListView({
      required List<Config> distributionConfigs,
    }) {
      String groupId = '1';
      return [
